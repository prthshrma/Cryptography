...
file = open('cipherTexts.txt', 'r')     # these cipherTexts should be corresponding to second characteristics
...
max4 = K[V.index(max(V))]
print("{}: {}".format(max4, freq4[max4]))
